...
4. **Fallback на iOS HTTP**
   - Ако Service Worker не работи → използва fetch interceptor
   - Ако и това не работи → показва версията от hardcoded константа
   - Version display показва: **"SW Limited"** с оранжева точка
