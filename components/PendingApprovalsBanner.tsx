        ...
        <div className="bg-yellow-900/50 border-2 border-yellow-500 rounded-xl p-4 md:p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg md:text-xl font-bold text-yellow-200 mb-2">
                {locale === 'bg' 
              ...
              <p className="text-sm md:text-base text-yellow-100 mb-3">
                {locale === 'bg'
                ...
                <div className="flex gap-2 flex-wrap">
                  {pendingApprovals.map((approval: any) => (
                    <button
                      ...
                      className="px-3 md:px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-black font-semibold rounded-lg transition-colors text-sm md:text-base"
                    >
                      {locale === 'bg'
